...
public class LearnInterfaceHDFCBank implements LearnInterfaceBank {

	long phone;
	String address;
	String id;
	
	public LearnInterfaceHDFCBank(long phone,String address, String id) {
	...
	public void accountDetails(String name, int accountNumber) {
		...
		System.out.println("HDFC: Account details retrieved");
